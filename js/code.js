...
button[12].addEventListener("click", nine);
button[13].addEventListener("click", eight);
button[14].addEventListener("click", seven);
button[15].addEventListener("click", division);
button[16].addEventListener("click", six);
button[17].addEventListener("click", five);
button[18].addEventListener("click", four);
button[19].addEventListener("click", subtraction);
button[20].addEventListener("click", three);
button[21].addEventListener("click", two);
button[22].addEventListener("click", one);
